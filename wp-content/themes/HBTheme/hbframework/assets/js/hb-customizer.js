...
( (function( $ ) {
	...
	wp.customize('hb_top_bar_text_color_setting',(function( value ) {
		value.bind((function(to) {
			...
			.hb-main-content a, #fancy-search ::-webkit-input-placeholder { color: "+to+"; }\
			</style>" ).appendTo( "head" );
		}));
	}));
	...
	wp.customize('hb_nav_bar_stuck_bg_setting',(function( value ) {
		value.bind((function(newval) {
			...
			jQuery("<style id='hb-toremove-2'>\
				.highend-sticky-header #header-inner #header-inner-bg { background-color:"+newval+" !important; }\
				</style>" ).appendTo( "head" );
		}));
	}));
	...
	wp.customize('hb_nav_bar_border_setting',(function( value ) {
		value.bind((function(newval) {
			...
			jQuery("<style id='hb-toremove-3'>\
				...
				#header-inner.nav-type-2 .main-navigation-container {border-top-color: "+newval+"}\
	...
	wp.customize('hb_nav_bar_stuck_border_setting',(function( value ) {
		value.bind((function(newval) {
			jQuery("<style id='hb-toremove-2'>\
				.highend-sticky-header #header-inner #header-inner-bg { border-bottom-color:"+newval+" !important; }\
				#main-nav li#nav-search::before {background: "+newval+"}\
				</style>" ).appendTo( "head" );
		}));
	}));
	...
	wp.customize('hb_nav_bar_stuck_text_setting',(function( value ) {
		value.bind((function(newval) {
			...
			jQuery("<style id='hb-toremove-112'>\
				.highend-sticky-header #main-wrapper #header-inner #main-nav > li > a, .highend-sticky-header #main-wrapper #header-inner #header-inner-bg { color:"+newval+" !important; }\
				</style>" ).appendTo( "head" );
		}));
	}));
	...
	wp.customize('hb_content_link_color_setting',(function( value ) {
		value.bind((function(newval) {
			...
			jQuery("<style id='hb-toremove-5'>\
				.hb-main-content a { color:"+newval+"; }\
				</style>" ).appendTo( "head" );
		}));
	}));
	...
	wp.customize('hb_content_h1_setting',(function( value ) {
		value.bind((function(to) {
			$('h1, h1.extra-large, h1 a, .single article h1.title').css('color', to ? to : '' );
		}));
	}));
