...
vp.init_tipsy = function()
{
	if (jQuery.fn.tipsy)
	{
		jQuery(document).tipsy({ live: '.vp-js-tipsy.description', gravity : 'e' });
		jQuery(document).tipsy({ live: '.vp-js-tipsy.slideinput', trigger : 'focus' });
		jQuery(document).tipsy({ live: '.vp-js-tipsy.image-item' });
	}
};
vp.init_tipsy();
