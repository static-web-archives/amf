...
if (jQuery("#hb_color_customizer_section .hb-buttons .vp-button").length) {
    var new_href = jQuery("a.hide-if-no-customize").attr("href");
    jQuery("#hb_color_customizer_section .hb-buttons .vp-button").attr("href", new_href)
}